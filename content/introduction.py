...
def introduction():
    ...
    st.write("* Comment évaluer la production des différentes filières énergétique ?")
    st.write("* Comment les énergies renouvelables sont-elles réparties géographiquement et quel impact ont-elles ? ")
    st.write("* Pouvons-nous prédire la consommation future afin d'éviter un black-out ?")
    st.write("En répondant à ces questions, nous pourrons prévoir précisément les futurs besoins énergétiques \
    ...
    st.write("* Visualiser la localisation et la capacité de production des énergies renouvelables")
